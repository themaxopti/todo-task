...
export const getTasks = (state: RootState): Task[] => state.tasks.tasks
export const modeSelector = (state: RootState): FilterMode => state.tasks.mode
export const tasksSelector = (state: RootState): Task[] => state.tasks.tasks
